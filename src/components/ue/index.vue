  ...
  methods: {
    ...
    async addYes() {
      ...
      if (this.activeNum == "one") {
        ...
        <div style="width:170px;height:200px; cursor: pointer;display: table-cell;text-align: center;"><img data-type="pic"
            ...
            <img data-id="${this.ids}" data-type="pic" class="dataRT" style="width: 100%;height: 50%;object-fit: cover;object-position: center;" src="${img[1]}" alt=""><img data-id="${this.ids}" data-type="pic" style="width: 100%;height: 50%;object-fit: cover;object-position: center;" src="${img[2]}" alt=""><span data-id="${this.ids}" class="data" data-type="pic" style="position: absolute;cursor: pointer;background: #2b323e;opacity: 0.8;width:100%;height: 100px;left: 0;bottom: 0;font-weight: 500; letter-spacing:2px; font-size:22px;line-height:100px;color:#fff;text-align: center; ">共${imgThis.length}张</span><div class="showIcon${this.ids} delete" style="text-align: center; position: absolute; top:-5px;display:none;right:-35px;width:120px"><button data-updateId="${this.ids}" class='updateBtn ckEditorToolbarBtn'>修 改</button><button     class='deleteBtn ckEditorToolbarBtn' data-deleteId="${this.ids}">删 除</button></div></div></div><div><br></div>`;
        ...
        <div style="width:170px;height:200px; cursor: pointer;display: table-cell;text-align: center;"><img
                data-id="${this.ids}" class="dataL" data-type="pic" style="width: 100%;height: 100%;object-fit: cover;object-position: center;" src="${img[0]}" alt=""></div><div style="display: flex;flex-direction: column;width:170px;height:200px;cursor: pointer;position:relative;">
            <img data-id="${this.ids}" data-type="pic" class="dataRT" style="width: 100%;height: 50%;object-fit: cover;object-position: center;" src="${img[1]}" alt=""><img data-id="${this.ids}" data-type="pic" style="width: 100%;height: 50%;object-fit: cover;object-position: center;" src="${img[2]}" alt=""><span data-id="${this.ids}" data-type="pic" class="data" style="position: absolute;cursor: pointer;background: #2b323e;opacity: 0.8;width:100%;height: 100px;left: 0;bottom: 0;font-weight: 500; letter-spacing:2px; font-size:22px;line-height:100px;color:#fff;text-align: center; ">共${imgThis.length}张</span><div class="showIcon${this.ids} delete" style="text-align: center; position: absolute; top:-5px;display:none;right:-35px;width:120px"><button data-updateId="${this.ids}" class='updateBtn ckEditorToolbarBtn'>修 改</button><button     class='deleteBtn ckEditorToolbarBtn' data-deleteId="${this.ids}">删 除</button></div></div></div><div><br></div>`;
        this.editor.execCommand("inserthtml", str);
        this.imgList = [];
        this.activeNum = "one";
        this.picList = [];
